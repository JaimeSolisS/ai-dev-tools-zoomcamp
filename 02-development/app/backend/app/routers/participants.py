...
def list_participants(session_id: str, principal: Principal, store: StoreDep):
    return store.list_participants(session_id)


@router.delete("/{participant_id}", status_code=204)
def remove_participant(session_id: str, participant_id: str, user: CurrentUser, store: StoreDep):
